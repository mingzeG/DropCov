...
@register_model
def Deit_drop_Tiny(pretrained=False, **kwargs):
    ...
    model = Vit(visualTokenConfig=visualTokenConfig, ViTConfig=ViTConfig, representationConfig=representationConfig, **kwargs)
    if pretrained:
        load_pretrained(
...
@register_model
def Deit_drop_Small(pretrained=False, **kwargs):
    ViTConfig['embed_dim']=384
    ViTConfig['depth']=12
    ViTConfig['num_heads']=6
    ViTConfig['mlp_ratio']=4
...
@register_model
def Deit_drop_Base(pretrained=False, **kwargs):
    ViTConfig['embed_dim']=768
    ViTConfig['depth']=12
    ViTConfig['num_heads']=12
    ViTConfig['mlp_ratio']=4
    representationConfig['args']['dim']=768
    representationConfig['args']['num_heads']=12
    representationConfig['args']['wr_dim']=24
    representationConfig['args']['normalization']['input_dim']=24
...
@register_model
def T2T_ViT_14(pretrained=False, **kwargs):
    ViTConfig['embed_dim']=384
    ViTConfig['depth']=14
    ViTConfig['num_heads']=6
    ...
    representationConfig['args']['num_heads']=6
    representationConfig['args']['normalization']['input_dim']=24
    representationConfig['args']['normalization']['p']=0.5
    if pretrained:
        kwargs.setdefault('qk_scale', 256 ** -0.5)
    model = Vit(visualTokenConfig=visualTokenConfig, ViTConfig=ViTConfig, representationConfig=representationConfig, **kwargs)
    if pretrained:
