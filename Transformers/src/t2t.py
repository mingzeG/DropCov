...
@register_model
def T2T_Drop_Tiny(pretrained=False, **kwargs):
    ...
    model = T2T_Drop(visualTokenConfig=visualTokenConfig, ViTConfig=ViTConfig, representationConfig=representationConfig, **kwargs)
    if pretrained:
        load_pretrained(
...
@register_model
def T2T_Drop_Small(pretrained=False, **kwargs):
...
@register_model
def T2T_Drop_Base(pretrained=False, **kwargs):
